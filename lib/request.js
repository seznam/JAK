...
JAK.Request.prototype.$constructor = function(type, options) {
	...
	if (this._type == JAK.Request.JSONP) {
		...
		this._xhr.onreadystatechange = JAK.bind(this, this._onReadyStateChange);
	}
...
JAK.Request.prototype._sendXHR = function(url, data) {
	...
	if (this._options.timeout) { setTimeout(JAK.bind(this, this._timeout), this._options.timeout); }
...
JAK.Request.prototype._sendScript = function(url, data) {
	...
	window[this._callback] = JAK.bind(this, this._scriptCallback);
