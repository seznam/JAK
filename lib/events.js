...
/**
 * vnitrni metoda volana z onDomReady, dulezite kvuli volani bez marametru pro IE, abychom v tom timeoutu mohli volat sama sebe
 * @private
 * @method 
 */ 
SZN.Events._onDomReady = function() {
	if((/Safari/i.test(navigator.userAgent)) || (/WebKit|Khtml/i.test(navigator.userAgent))){ //safari, konqueror
  	...
  	SZN.Events.addListener(window, 'load', window, function(){/*alert('onload');*/ SZN.Events._domReady();});
}
