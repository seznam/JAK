 ...
 * @private
 * @returns {string} verze prohlizece od 1.5 do 5 (> 5 bude detekovano jako 5)
 */ 
JAK.Browser._get_gecko_ver = function() {
	if ("onloadend" in new XMLHttpRequest()) { 
		return "5";
	} else if (history.pushState) { 
		return "4";
	} else if (document.getBoxObjectFor === undefined && navigator.geolocation) { 
		return "3.6";
