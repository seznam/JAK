 ...
 * @static
 * @name SZN.ClassMaker
 * @class statická třída sestavující dědičnost rozšiřováním prototypováho objektu
...
/**
 * @method vlastní metoda pro vytvoření třídy, v jediném parametru se dozví informace o třídě, kterou má vytvořit
...
/**
 * 
 * @method vytváří třídu pro další použití z literálového zápisu s přesně definovaným tvarem
...
/**
 * @private
 * @method metoda sloužící ke zdědění jako statická metoda vytvářené třídy
...
/**
 * @method ziskává a vrací v poli třídy, ze kterých bude nová třída dědit 
...
/**
 * @private
 * @method volá vlastní kopírování prototypových vlastností jednotlivých rodičů
 * 	 
...
/**
 * @private
 * @method provadí vlastní kopírovaní prototypových vlastností z rodiče do potomka
...
/**
 * @private
 * @method testuje závislosti vytvářené třídy, pokud jsou nastavené
...
/**
 * @static
 * @method zjednodušený přístup k metodě DOM document.getElementById
...
/**
 * @method vrací velikost dokumentu, pro správnou funkcionalitu je třeba aby
...
/**
 * @method vrací polohu "obj" ve stránce nebo uvnitř objektu který předám jako druhý 
 * argument
...
/**
 * @method vrací polohu "obj" v okně nebo uvnitř objektu který předáme jako druhý 
...
/**
 * @method vrací dvojici čísel, o kolik je "obj" odscrollovaný vůči oknu nebo vůči zadanému rodičovskému objektu
...
/**
 * @method vrací aktuální odskrolování stránky 
 * @returns {object} s vlastnostmi:
...
/**
 * @method vraci současnou hodnotu nějaké css vlastnosti
...
/**
 * @method skrývá elementy které se mohou objevit v nejvyšší vrstvě a překrýt obsah,
...
/**
 * @method vrati kolekci elementů které mají nadefinovanou třídu <em>searchClass</em>
...
/**
 * @overview Préce HTTPxmlRequestem pro komunikaci klient - server
 * @version 1.0
 * @author koko, jelc 
 */   
...
/**
 * @method inicializace <strong>nepoužívá se</strong>
 *
 */  
...
/**
 * @method nastavuje format odpovědi serveru dle argumentu, pokud argument
...
/**
 * @method nastavuje HTTP hlavičky dotazu
...
/**
 * @method nastavuje data, která se mají posílat metodou POST
...
/**
 * @method vlastní vyvolání HTTPxmlRequestu, předané parametry se použijí pro konkretní dotaz
...
/**
 * @method umožňuje zrušit asynchroní dotaz pokud již není zpracováván
...
/**
 * @private
 * @method vrací metodu jakou bude probíhat komunikace klient - server pokud je známá,
...
/**
 * @private
 * @method vrací mod v jakém bude probíhat komunikace klient - server pokud je známá,
...
/**
 * @private
 * @method vrací formát jakou bude probíhat komunikace klient - server pokud je znám,
...
/**
 * @private
 * @method připravuje nastavení HTTP hlaviček pro zasílany dotaz, pokud nenajde v
...
/**
 * @private
 * @method provadí nastavení vlastností pro daný dotaz, aktuálně volanou metodu
...
/**
 * @private
 * @method crossplatformí vytváření HTTPxmlRequestu 
...
/**
 * @method vkládání "globálních" zpráv
...
/**
 * @method registrace posluchače uživatelské události, pokud je již na stejný druh 
...
/**
 * @private
 * @method vlastni registrace posluchače uživatelské události
...
/**
 * @method odstranění naslouchání události
 * argumenty:
...
/**
 * @method vytváří událost, ukládá ji do zásobníku události a předává ji ke zpracování
...
/**
 * @method zpracuje událost - spustí metodu, která byla zaragistrována jako posluchač 
...
/**
 * @method destruktor události, odstraní událost definovanou 
...
/**
 * @method slouží k nalezení rozhraní u rodičovských tříd, hledá v nadřazených třídách třídu,
...
/**
 * @method slouží k registraci zachytávaní události 
...
/**
 * @method slouží k zrušení zachytáváni události 
...
/**
 * @method vytváří novou událost, kterou zachytáva instance třídy SZN.sigInterface
...
/**
 * @method nastavuje zprávu se jménem <em>msgName</em> na hodnotu <em>msgValue</em>
 * @param {string} msgName název zprávy
...
/**
 * @method čte zprávu se jménem <em>msgName</em>
 * @param {string} msgName název zprávy
