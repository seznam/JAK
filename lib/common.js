...
SZN.Browser._getMouse = function(){
	var left;
	var right;
	if ((this.klient == 'ie') || (this.klient == 'konqueror')){
		left = 1;
		right = 2;
	} else if((this.klient == 'opera') && (this.version > 7) && (this.version < 9)) {
		left = 1;
		right = 2;
	} else if (this.klient == 'safari'){
...
/**
 * @method vraci dvojici cisel, o kolik je "obj" odscrollovany vuci strance nebo vuci zadanemu rodicovskemu objektu
