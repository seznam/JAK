...
*/
SZN.SigInterface = function(owner,name){
	/** 
	 * @private
...
SZN.SigInterface.Name = 'SigInterface';
SZN.SigInterface.prototype.Name = 'SigInterface';
SZN.SigInterface.prototype.CLASS = true;
/**
 * @method inicializace rozhrani zatim prazdne
 */
	...
	for(var i in this.myHandleFolder){
		if((i == myEvent.type)){
			for(j in this.myHandleFolder[i]){
				var owner = this.myHandleFolder[i][j].eOwner;
				var fnc = this.myHandleFolder[i][j].eFunction;
