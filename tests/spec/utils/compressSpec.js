describe('Compress', function(){
	...
	describe('UTF8', function() {
		...
		it('should convert string -> array of utf8 bytes -> string', function(){
				expect(s).toEqual(s2);
		});
	...
	describe('BWT', function() {
		...
		it('should compress given 128 marks', function() {
			var data = createTestData(1, 128);
			var bytes = JAK.Compress.stringToArray(data, JAK.Compress.UTF8);
		...
		it('should compress given 127 marks', function(){
			var data = createTestData(0, 127);
			var bytes = JAK.Compress.stringToArray(data, JAK.Compress.UTF8);
			var bwt = JAK.Compress.BWT(bytes, {mark:127});
			var ibwt = JAK.Compress.iBWT(bwt, {mark:127});
			var result = JAK.Compress.arrayToString(ibwt, JAK.Compress.UTF8);
			expect(data).toEqual(result);
		});
	});
